...
const Agreements = () => (
  <section className="agreement-page">
    <div className="page-intro agreement-intro">
      ...
      <Tag className="agreement-status" icon={<CheckCircleFilled />}>已生效</Tag>
    </div>
      ...
      <div className="agreement-details">
        ...
        <Card className="agreement-card" bordered={false} title="产品配置">
          <div className="agreement-plan">
            <div className="plan-icon"><SafetyCertificateOutlined /></div>
            <div>
              <span>企业专业版</span>
          ...
          <div className="config-list">
            <div><span>已开通模块</span><strong>商品、订单、财务</strong></div>
            <div><span>账号配额</span><strong>80 个</strong></div>
            <div><span>文件存储</span><strong>500 GB</strong></div>
            <div><span>技术支持</span><strong>7 × 12 小时</strong></div>
          </div>
        </Card>
      </div>
